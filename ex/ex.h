...
#ifdef EXSTRINGS
var	int	erfile;		/* Error message file unit */
#endif
...
var	short	ex_stdin;	/* Standard in */
var	short	ex_stdout;	/* Standard output */
var	int	io;		/* General i/o unit (auto-closed on error!) */
