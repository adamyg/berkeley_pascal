 ...
 */
int	linend = 0;		/* The column position of end of line */
int	tabstart = 0;		/* Column of start of first following tab */
int	tabend = 0;		/* Column of end of following tabs */
int	tabsize = 0;		/* Size of the following tabs */
int	tabslack = 0;		/* Number of ``spaces'' in following tabs */
int	inssiz = 0;   		/* Number of characters to be inserted */
int	inscol = 0;   		/* Column where insertion is taking place */
int	shft = 0;     		/* Amount tab expansion shifted rest of line */
int	slakused = 0;		/* This much of tabslack will be used up */
